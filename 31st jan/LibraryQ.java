...
class LibraryQ{
	public static void main(String[] args) {
		...
		Book b1 = new Book(1001,"Life",10,"Pranay",900);
		b1.display();
		System.out.println(b1.getCost());
		JournalPaper j = new JournalPaper(2001,"E-commerce and its benefits",1,"John S",2020,200);
		j.display();
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter the value of R in MediaItem");
		int r = sc.nextInt();
		Cd c = new Cd(2004,"I Want To Break Free",9,r,"King","Rock");
		c.display();
		c.getCost();
	}
}